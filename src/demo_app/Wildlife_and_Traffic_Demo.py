...
st.markdown(
   ...
   The dashboard helps PDRT view animal activity in Zimbabwe at different times and in different environmental conditions. It also enables PDRT to keep track of traffic speed, especially overspeeding, in national parks and forests in Zimbabwe.   
